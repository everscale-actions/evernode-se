...
global.nodeSePort = parseInt(process.env.TONOS_SE_NODE_PORT, 10) || config['ton-node-port'];
global.nodeSeRequestsPort = parseInt(process.env.TONOS_SE_NODE_API_PORT, 10) || config['ton-node-api-port'];
